...
document.getElementById("get-strted-btn").addEventListener("click", function() {
  ...
  if (emailValue === "" || !emailValue.includes("@") || !emailValue.includes(".")) {
    ...
    window.location.href = `../Signup/linkRegistrationlocale=en-IN/?email=${encodeURIComponent(email)}`;
    // window.location.href = `../Signup/linkRegistrationlocale=en-IN/index.html?email=${encodeURIComponent(email)}`;
  }
});
...
window.addEventListener("load", () => {
  document.querySelectorAll(".popup-get-strted-btn").forEach(button => {
    button.addEventListener("click", function () {
      window.location.href = "../Signup/linkRegistrationlocale=en-IN/";
    });
  });
});
